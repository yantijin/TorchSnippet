...
import math
import torch
from TorchSnippet.dyna import NaturalCubicSpline, cdeint, natural_cubic_spline_coeffs
...
def main(num_epochs=30):
    ...
    ######################
    train_coeffs = natural_cubic_spline_coeffs(train_X)
    ...
    test_coeffs = natural_cubic_spline_coeffs(test_X)
