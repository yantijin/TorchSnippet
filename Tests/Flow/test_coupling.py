...
import torch
from TorchSnippet.Flow.coupling import *
from TorchSnippet.Flow.scale import *
from ..helper import flow_standard_check
from TorchSnippet.typing_ import *
from typing import *

class Branch(tsp.Layers.BaseSplitLayer):
    """
...
def check_coupling_layer(ctx,
    ...
    for scale in ('invalid', object(), tsp.Layers.Linear(2, 3)):
...
class TestCouplingLayer(object):
    ...
    def test_CouplingLayer(self):
        def shift_and_pre_scale_factory(n1, n2):
            ...
            return Branch(
                [
                    tsp.Layers.Linear(10, n2),
                    tsp.Layers.Linear(10, n2),
                ],
                shared=tsp.Layers.Linear(n1, 10),
            )
    ...
    def test_CouplingLayerNd(self):
        for spatial_ndims in (1, 2, 3):
            ...
            conv_cls = getattr(tsp.Layers, f'LinearConv{spatial_ndims}d')
            ...
            check_coupling_layer(
                ...
                num_features=5,
                cls=getattr(tsp.Flow, f'CouplingLayer{spatial_ndims}d'),
                shift_and_pre_scale_factory=shift_and_pre_scale_factory,
            )
